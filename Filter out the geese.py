...
as in the initial array passed to your function, albeit with
the 'geese' removed. Note that all of the strings will be in
the same case as those provided, and some elements may be
repeated.
"""
...
def goose_filter(birds):
    for goose in geese:
        if goose in birds: birds.remove(goose)
    return birds
